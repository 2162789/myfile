			 ...
			 while($row = mysqli_fetch_array($result))
		      {  
		      	...
		      	<tr>
		      		...
		      		if ($_SESSION['users']['em_position'] == 'Employee') {
		      		echo '<a href="download.php?dow='.$path.'"><input type="button" class="btn btn-success" value="Download"/></a>
...
<div class="overlay">
<iframe style="border:0px" src="<?php echo $location?>#toolbar=0&navpanes=0"width="500" height=500>
</iframe>	
</div>
