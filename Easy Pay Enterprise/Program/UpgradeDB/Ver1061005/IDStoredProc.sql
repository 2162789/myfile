if exists(select * from sys.sysprocedure where proc_name = 'ASQLCalPayPeriodJamsoWage') then
...
if exists(select * from sys.sysprocedure where proc_name = 'ASQLCalPayRecJamsoWage') then
