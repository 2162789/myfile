...
then
   ALTER VIEW "DBA"."View_TMS_Holidays"
   AS
...
then
   ALTER VIEW "DBA"."View_TMS_LeaveType"
   AS
   SELECT LeaveType.LeaveTypeID, LeaveTypeDesc, LeaveFunctionId from LeaveType JOIN LeaveComputation
else
...
then
   ALTER VIEW "DBA"."View_TMS_OTRate"
   AS
...
then
   ALTER VIEW "DBA"."View_TMS_PayRecID"
   AS
...
then
   ALTER VIEW "DBA"."View_TMS_SmartTouch_BasicRateProgression"
...
//-----------------------------------
// Update SubRegistry for Security Grant 
//-----------------------------------
IF NOT exists(select * FROM SubRegistry where SubRegistryId='TMSViewQry') THEN
    INSERT INTO Subregistry(RegistryId,SubRegistryId,RegProperty1) VALUES ('TMS Vendor','TMSViewQry','View_TMS_Query');
END IF;

IF NOT exists(select * FROM SubRegistry where SubRegistryId='TMSViewPayRecID') THEN
    INSERT INTO Subregistry(RegistryId,SubRegistryId,RegProperty1) VALUES ('TMS Vendor','TMSViewPayRecID','View_TMS_PayRecID');
END IF;

IF NOT exists(select * FROM SubRegistry where SubRegistryId='TMSViewOTRate') THEN
    INSERT INTO Subregistry(RegistryId,SubRegistryId,RegProperty1) VALUES ('TMS Vendor','TMSViewOTRate','View_TMS_OTRate');
END IF;

IF NOT exists(select * FROM SubRegistry where SubRegistryId='TMSViewAllowanceID') THEN
    INSERT INTO Subregistry(RegistryId,SubRegistryId,RegProperty1) VALUES ('TMS Vendor','TMSViewAllowanceID','View_TMS_AllowanceID');
END IF;

IF NOT exists(select * FROM SubRegistry where SubRegistryId='TMSViewLeaveType') THEN
    INSERT INTO Subregistry(RegistryId,SubRegistryId,RegProperty1) VALUES ('TMS Vendor','TMSViewLeaveType','View_TMS_LeaveType');
END IF;

IF NOT exists(select * FROM SubRegistry where SubRegistryId='TMSViewHolidays') THEN
    INSERT INTO Subregistry(RegistryId,SubRegistryId,RegProperty1) VALUES ('TMS Vendor','TMSViewHolidays','View_TMS_Holidays');
END IF;
