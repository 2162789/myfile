...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayPeriodPFSSWage') then
   drop procedure ASQLCalPayPeriodPFSSWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecPFSSWage') then
   drop procedure ASQLCalPayRecPFSSWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteThTaxDetails') then
   drop procedure DeleteThTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteThTaxEmployee') then
   drop procedure DeleteThTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteThTaxEmployer') then
   drop procedure DeleteThTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteThTaxPolicy') then
   drop procedure DeleteThTaxPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteThTaxProgression') then
   drop procedure DeleteThTaxProgression
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteThTaxRecord') then
   drop procedure DeleteThTaxRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetEmployeeStatus') then
   drop procedure FGetEmployeeStatus
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetProvidentFundFormula') then
   drop procedure FGetProvidentFundFormula
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetThTaxEmployerAddr') then
   drop procedure FGetThTaxEmployerAddr
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewThTaxEmployee') then
   drop procedure InsertNewThTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewThTaxEmployer') then
   drop procedure InsertNewThTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewThTaxPolicy') then
   drop procedure InsertNewThTaxPolicy
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'IsPreviousPeriodDiff') then
   drop procedure IsPreviousPeriodDiff
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateThTaxEmployee') then
   drop procedure UpdateThTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateThTaxEmployer') then
   drop procedure UpdateThTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateThTaxPolicy') then
   drop procedure UpdateThTaxPolicy
end if
;
