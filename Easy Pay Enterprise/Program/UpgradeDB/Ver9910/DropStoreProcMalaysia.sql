...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayPeriodEPFWage') then
   drop procedure ASQLCalPayPeriodEPFWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayPeriodSOCSOWage') then
   drop procedure ASQLCalPayPeriodSOCSOWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecEPFWage') then
   drop procedure ASQLCalPayRecEPFWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecSOCSOWage') then
   drop procedure ASQLCalPayRecSOCSOWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLGetMalFamilyInfo') then
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteEPFProgression') then
   drop procedure DeleteEPFProgression
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteEPFProgressionRec') then
   drop procedure DeleteEPFProgressionRec
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteMalSTDPolicy') then
   drop procedure DeleteMalSTDPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteMalSTDPolicyTable') then
   drop procedure DeleteMalSTDPolicyTable
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteMalTaxBranch') then
   drop procedure DeleteMalTaxBranch
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteMalTaxEmployee') then
   drop procedure DeleteMalTaxEmployee
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteSOCSOProgression') then
   drop procedure DeleteSOCSOProgression
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteSOCSOProgressionRec') then
   drop procedure DeleteSOCSOProgressionRec
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetBankBNMCode') then
   drop procedure FGetBankBNMCode
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCP159PeriodToMonthYear') then
   drop procedure FGetCP159PeriodToMonthYear
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetEPFProgPreviousProgDate') then
   drop procedure FGetEPFProgPreviousProgDate
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalSpouseTaxRefNoChkMale') then
   drop procedure FGetMalSpouseTaxRefNoChkMale
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxEmployerBranch') then
   drop procedure FGetMalTaxEmployerBranch
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxErFileNoE') then
   drop procedure FGetMalTaxErFileNoE
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxErFileNoEByEmp') then
   drop procedure FGetMalTaxErFileNoEByEmp
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxFileNoE') then
   drop procedure FGetMalTaxFileNoE
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxNJAllowance') then
   drop procedure FGetMalTaxNJAllowance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxNJEmoluments') then
   drop procedure FGetMalTaxNJEmoluments
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxPrevERAddr') then
   drop procedure FGetMalTaxPrevERAddr
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxPrevERName') then
   drop procedure FGetMalTaxPrevERName
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxReceiptDate') then
   drop procedure FGetMalTaxReceiptDate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxReceiptNo') then
   drop procedure FGetMalTaxReceiptNo
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMalTaxRecordYear') then
   drop procedure FGetMalTaxRecordYear
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMlsiaEPFFormula') then
   drop procedure FGetMlsiaEPFFormula
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPeriodEEEPFWage') then
   drop procedure FGetPeriodEEEPFWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPeriodTotalEeEPF') then
   drop procedure FGetPeriodTotalEeEPF
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPeriodTotalTaxWage') then
   drop procedure FGetPeriodTotalTaxWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPeriodTotalZakat') then
   drop procedure FGetPeriodTotalZakat
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPersonalMalaysiaOldIC') then
   drop procedure FGetPersonalMalaysiaOldIC
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPersonalMalaysiaTaxNo') then
   drop procedure FGetPersonalMalaysiaTaxNo
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetSOCSOProgPreviousProgDate') then
   drop procedure FGetSOCSOProgPreviousProgDate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetSpouseMalTaxRefNo') then
   drop procedure FGetSpouseMalTaxRefNo
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetTaxBranchNo') then
   drop procedure FGetTaxBranchNo
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMalSTDPolicy') then
   drop procedure InsertNewMalSTDPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMalSTDPolicyTable') then
   drop procedure InsertNewMalSTDPolicyTable
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMalTaxBranch') then
   drop procedure InsertNewMalTaxBranch
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMalTaxDetails') then
   drop procedure InsertNewMalTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMalTaxEmployee') then
   drop procedure InsertNewMalTaxEmployee
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMalTaxPolicy') then
   drop procedure InsertNewMalTaxPolicy
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewSOCSOProgression') then
   drop procedure InsertNewSOCSOProgression
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMalSTDPolicy') then
   drop procedure UpdateMalSTDPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMalSTDPolicyTable') then
   drop procedure UpdateMalSTDPolicyTable
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMalTaxBranch') then
   drop procedure UpdateMalTaxBranch
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMalTaxDetails') then
   drop procedure UpdateMalTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMalTaxEmployee') then
   drop procedure UpdateMalTaxEmployee
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMalTaxPolicy') then
   drop procedure UpdateMalTaxPolicy
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateSOCSOProgression') then
   drop procedure UpdateSOCSOProgression
end if
;
