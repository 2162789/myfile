...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetBruneiCPFFormula') then
   drop procedure FGetBruneiCPFFormula
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetBruneiEmpTAPACC') then
   drop procedure FGetBruneiEmpTAPACC
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetBruneiPaymentMode') then
   drop procedure FGetBruneiPaymentMode
end if
;
