...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCreatePhTaxATC') then
   drop procedure ASQLCreatePhTaxATC
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLPhDependentFromFamily') then
   drop procedure ASQLPhDependentFromFamily
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLRecalPhTaxATC') then
   drop procedure ASQLRecalPhTaxATC
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeletePhATCCode') then
   drop procedure DeletePhATCCode
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeletePhTaxEmployee') then
   drop procedure DeletePhTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeletePhTaxEmployer') then
   drop procedure DeletePhTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeletePhTaxPolicy') then
   drop procedure DeletePhTaxPolicy
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeletePhTaxRecord') then
   drop procedure DeletePhTaxRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeletePhTaxRecordByPersonalSysId') then
   drop procedure DeletePhTaxRecordByPersonalSysId
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetHDMFP24UseCode') then
   drop procedure FGetHDMFP24UseCode
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPh1601CAdjustments') then
   drop procedure FGetPh1601CAdjustments
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGETPhEmploymentStatusByPeriod') then
   drop procedure FGETPhEmploymentStatusByPeriod
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPhME5SumDatePaid') then
   drop procedure FGetPhME5SumDatePaid
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPhME5SumME5ReconNo') then
   drop procedure FGetPhME5SumME5ReconNo
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetPhTaxYearResidenceType') then
   drop procedure FGetPhTaxYearResidenceType
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewPhATCCode') then
   drop procedure InsertNewPhATCCode
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewPhTaxATC') then
   drop procedure InsertNewPhTaxATC
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewPhTaxEmployee') then
   drop procedure InsertNewPhTaxEmployee
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewPhTaxPolicy') then
   drop procedure InsertNewPhTaxPolicy
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdatePhATCCode') then
   drop procedure UpdatePhATCCode
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdatePhTaxEmployee') then
   drop procedure UpdatePhTaxEmployee
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdatePhTaxPolicy') then
   drop procedure UpdatePhTaxPolicy
end if
;
