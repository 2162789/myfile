...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayPeriodJamsoWage') then
   drop procedure ASQLCalPayPeriodJamsoWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecJamsoWage') then
   drop procedure ASQLCalPayRecJamsoWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLIndoTax') then
   drop procedure ASQLIndoTax
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLProcessIndoTax') then
   drop procedure ASQLProcessIndoTax
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxDetails') then
   drop procedure DeleteIndoTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxEmployee') then
   drop procedure DeleteIndoTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxEmployer') then
   drop procedure DeleteIndoTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxMonthly') then
   drop procedure DeleteIndoTaxMonthly
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxPolicy') then
   drop procedure DeleteIndoTaxPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxPolicyProg') then
   drop procedure DeleteIndoTaxPolicyProg
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxRecord') then
   drop procedure DeleteIndoTaxRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxRecordByPersonalSysId') then
   drop procedure DeleteIndoTaxRecordByPersonalSysId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIndoTaxRegion') then
   drop procedure DeleteIndoTaxRegion
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCompanyCity') then
   drop procedure FGetCompanyCity
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetGikenJamsostekNo') then
   drop procedure FGetGikenJamsostekNo
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetIndoEmpJamsostekACC') then
   drop procedure FGetIndoEmpJamsostekACC
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetIndoMonthName') then
   drop procedure FGetIndoMonthName
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetIndonCPFFormula') then
   drop procedure FGetIndonCPFFormula
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxEmployee') then
   drop procedure InsertNewIndoTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxEmployer') then
   drop procedure InsertNewIndoTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxMonthly') then
   drop procedure InsertNewIndoTaxMonthly
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxPolicy') then
   drop procedure InsertNewIndoTaxPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxPolicyProg') then
   drop procedure InsertNewIndoTaxPolicyProg
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxRecord') then
   drop procedure InsertNewIndoTaxRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIndoTaxRegion') then
   drop procedure InsertNewIndoTaxRegion
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'PatchIndoTaxDetails') then
   drop procedure PatchIndoTaxDetails
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxEmployee') then
   drop procedure UpdateIndoTaxEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxEmployer') then
   drop procedure UpdateIndoTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxMonthly') then
   drop procedure UpdateIndoTaxMonthly
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxPolicy') then
   drop procedure UpdateIndoTaxPolicy
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxPolicyProg') then
   drop procedure UpdateIndoTaxPolicyProg
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxRecord') then
   drop procedure UpdateIndoTaxRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIndoTaxRegion') then
   drop procedure UpdateIndoTaxRegion
end if
;
