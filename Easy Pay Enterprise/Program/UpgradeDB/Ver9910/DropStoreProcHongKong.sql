...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayPeriodEOWage') then
   drop procedure ASQLCalPayPeriodEOWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecMPFManAddWage') then
   drop procedure ASQLCalPayRecMPFManAddWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecMPFManOrdWage') then
   drop procedure ASQLCalPayRecMPFManOrdWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecMPFVolAddWage') then
   drop procedure ASQLCalPayRecMPFVolAddWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCalPayRecMPFVolOrdWage') then
   drop procedure ASQLCalPayRecMPFVolOrdWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLMPFForSubmission') then
   drop procedure ASQLMPFForSubmission
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKIR56BRecord') then
   drop procedure DeleteHKIR56BRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKIR56ERecord') then
   drop procedure DeleteHKIR56ERecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKIR56FRecord') then
   drop procedure DeleteHKIR56FRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKIR56GRecord') then
   drop procedure DeleteHKIR56GRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKIR56MRecord') then
   drop procedure DeleteHKIR56MRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKOrdinance') then
   drop procedure DeleteHKOrdinance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKOrdinanceByEmployeeSysId') then
   drop procedure DeleteHKOrdinanceByEmployeeSysId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKPeriodOrdinance') then
   drop procedure DeleteHKPeriodOrdinance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKPeriodOrdinanceByEmployeeSysId') then
   drop procedure DeleteHKPeriodOrdinanceByEmployeeSysId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKPlaceOfRes') then
   drop procedure DeleteHKPlaceOfRes
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKTaxDetails') then
   drop procedure DeleteHKTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKTaxEmployer') then
   drop procedure DeleteHKTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteHKTaxRecord') then
   drop procedure DeleteHKTaxRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteMPFProgression') then
   drop procedure DeleteMPFProgression
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCurrentMPFMembershipNo') then
   drop procedure FGetCurrentMPFMembershipNo
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetEmployeePersonalTypeId') then
   drop procedure FGetEmployeePersonalTypeId
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetHKTaxableItemsAmount') then
   drop procedure FGetHKTaxableItemsAmount
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetHKTaxableItemsDesc') then
   drop procedure FGetHKTaxableItemsDesc
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetHKTaxableItemsPeriod') then
   drop procedure FGetHKTaxableItemsPeriod
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetHKTaxableItemsPeriodForSubmit') then
   drop procedure FGetHKTaxableItemsPeriodForSubmit
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMonthLastDay') then
   drop procedure FGetMonthLastDay
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMPFContriEndDate') then
   drop procedure FGetMPFContriEndDate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMPFContriStartDate') then
   drop procedure FGetMPFContriStartDate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMPFFormula') then
   drop procedure FGetMPFFormula
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMPFProgPreviousProgDate') then
   drop procedure FGetMPFProgPreviousProgDate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetMPFUserDefCode') then
   drop procedure FGetMPFUserDefCode
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKIR56BRecord') then
   drop procedure InsertNewHKIR56BRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKIR56ERecord') then
   drop procedure InsertNewHKIR56ERecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKIR56FRecord') then
   drop procedure InsertNewHKIR56FRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKIR56GRecord') then
   drop procedure InsertNewHKIR56GRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKIR56MRecord') then
   drop procedure InsertNewHKIR56MRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKOrdinance') then
   drop procedure InsertNewHKOrdinance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKPeriodDisregard') then
   drop procedure InsertNewHKPeriodDisregard
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKPeriodOrdinance') then
   drop procedure InsertNewHKPeriodOrdinance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKPlaceOfRes') then
   drop procedure InsertNewHKPlaceOfRes
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKTaxableItems') then
   drop procedure InsertNewHKTaxableItems
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKTaxDetails') then
   drop procedure InsertNewHKTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKTaxEmployer') then
   drop procedure InsertNewHKTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKTaxRecord') then
   drop procedure InsertNewHKTaxRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewHKTaxYear') then
   drop procedure InsertNewHKTaxYear
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewMPFProgression') then
   drop procedure InsertNewMPFProgression
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKIR56BRecord') then
   drop procedure UpdateHKIR56BRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKIR56ERecord') then
   drop procedure UpdateHKIR56ERecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKIR56FRecord') then
   drop procedure UpdateHKIR56FRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKIR56GRecord') then
   drop procedure UpdateHKIR56GRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKIR56MRecord') then
   drop procedure UpdateHKIR56MRecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKOrdinance') then
   drop procedure UpdateHKOrdinance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKPeriodOrdinance') then
   drop procedure UpdateHKPeriodOrdinance
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKPlaceOfRes') then
   drop procedure UpdateHKPlaceOfRes
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKTaxableItems') then
   drop procedure UpdateHKTaxableItems
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKTaxDetails') then
   drop procedure UpdateHKTaxDetails
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKTaxEmployer') then
   drop procedure UpdateHKTaxEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateHKTaxRecord') then
   drop procedure UpdateHKTaxRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateMPFProgression') then
   drop procedure UpdateMPFProgression
end if
;
