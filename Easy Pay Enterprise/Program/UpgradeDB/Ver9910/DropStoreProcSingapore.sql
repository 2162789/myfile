...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLCasPayCPFWage') then
   drop procedure ASQLCasPayCPFWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLNSGenerateOffDays') then
   drop procedure ASQLNSGenerateOffDays
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLNSItemRecord') then
   drop procedure ASQLNSItemRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLTimeSheetDistributeCPF') then
   drop procedure ASQLTimeSheetDistributeCPF
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLTimeSheetDistributeFWL') then
   drop procedure ASQLTimeSheetDistributeFWL
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLUpdateCasDistribute') then
   drop procedure ASQLUpdateCasDistribute
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLUpdateIRASNationality') then
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLUpdateNSLastGeneration') then
   drop procedure ASQLUpdateNSLastGeneration
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYECreateA8A_S2S3') then
   drop procedure ASQLYECreateA8A_S2S3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYECreateIR21A1_S2S3') then
   drop procedure ASQLYECreateIR21A1_S2S3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEEmploymentHistory') then
   drop procedure ASQLYEEmploymentHistory
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEIR8SCrossUpdate') then
   drop procedure ASQLYEIR8SCrossUpdate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessA8A') then
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessIR21') then
   drop procedure ASQLYEProcessIR21
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessIR21A2') then
   drop procedure ASQLYEProcessIR21A2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessIR21A3') then
   drop procedure ASQLYEProcessIR21A3
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessIR8S') then
   drop procedure ASQLYEProcessIR8S
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessIR8SA') then
   drop procedure ASQLYEProcessIR8SA
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessPension') then
   drop procedure ASQLYEProcessPension
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEProcessYERecord') then
   drop procedure ASQLYEProcessYERecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEReprocessA8A_S2S3') then
   drop procedure ASQLYEReprocessA8A_S2S3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'ASQLYEReprocessIR21A1_S2S3') then
   drop procedure ASQLYEReprocessIR21A1_S2S3
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8A') then
   drop procedure DeleteA8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8AByPersonalSysId') then
   drop procedure DeleteA8AByPersonalSysId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8AS2') then
   drop procedure DeleteA8AS2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8AS3') then
   drop procedure DeleteA8AS3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8B') then
   drop procedure DeleteA8B
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8BByPersonalSysId') then
   drop procedure DeleteA8BByPersonalSysId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteA8BRecord') then
   drop procedure DeleteA8BRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteCasRecord') then
   drop procedure DeleteCasRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteEmploymentHistory') then
   drop procedure DeleteEmploymentHistory
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteEmploymentHistorybyPerId') then
   drop procedure DeleteEmploymentHistorybyPerId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteEmploymentHistoryByPersonalSysID') then
   drop procedure DeleteEmploymentHistoryByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteEmploymentHistoryByYEYear') then
   drop procedure DeleteEmploymentHistoryByYEYear
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21A2') then
   drop procedure DeleteIR21A2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21A2ByPersonalSysID') then
   drop procedure DeleteIR21A2ByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21A2Record') then
   drop procedure DeleteIR21A2Record
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21A3') then
   drop procedure DeleteIR21A3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21A3ByPersonalSysID') then
   drop procedure DeleteIR21A3ByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21A3Record') then
   drop procedure DeleteIR21A3Record
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21Details') then
   drop procedure DeleteIR21Details
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR21DetailsByPersonalSysID') then
   drop procedure DeleteIR21DetailsByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8A') then
   drop procedure DeleteIR8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8AByPersonalSysID') then
   drop procedure DeleteIR8AByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8AByYEYear') then
   drop procedure DeleteIR8AByYEYear
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8S') then
   drop procedure DeleteIR8S
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8SA') then
   drop procedure DeleteIR8SA
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8SATwoID') then
   drop procedure DeleteIR8SATwoID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIR8SByPersonalSysId') then
   drop procedure DeleteIR8SByPersonalSysId
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteIRASNationality') then
   drop procedure DeleteIRASNationality
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteMedisaveProgression') then
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteNSPayCase') then
   drop procedure DeleteNSPayCase
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYEEmployee') then
   drop procedure DeleteYEEmployee
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYEEmployeeByPersonalSysID') then
   drop procedure DeleteYEEmployeeByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYEEmployer') then
   drop procedure DeleteYEEmployer
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYEGlobal') then
   drop procedure DeleteYEGlobal
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYERecord') then
   drop procedure DeleteYERecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYERecordByPersonalSysID') then
   drop procedure DeleteYERecordByPersonalSysID
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'DeleteYERecordByYEYear') then
   drop procedure DeleteYERecordByYEYear
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetA8AS2Items') then
   drop procedure FGetA8AS2Items
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetA8AS2Rate') then
   drop procedure FGetA8AS2Rate
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetA8AS2Units') then
   drop procedure FGetA8AS2Units
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetA8AS2Value') then
   drop procedure FGetA8AS2Value
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetA8AS3C1Value') then
   drop procedure FGetA8AS3C1Value
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasRecordCurAdditionalWage') then
   drop procedure FGetCasRecordCurAdditionalWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasRecordCurOrdinaryWage') then
   drop procedure FGetCasRecordCurOrdinaryWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasRecordNonCPFWage') then
   drop procedure FGetCasRecordNonCPFWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasRecordTotalDailyWage') then
   drop procedure FGetCasRecordTotalDailyWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasRecordTotalDailyWageByEmp') then
   drop procedure FGetCasRecordTotalDailyWageByEmp
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasRecordTotalNoOfHoursByEmp') then
   drop procedure FGetCasRecordTotalNoOfHoursByEmp
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasualBasis') then
   drop procedure FGetCasualBasis
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasualBasisUserDefinedName') then
   drop procedure FGetCasualBasisUserDefinedName
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetCasualBatchDesc') then
   drop procedure FGetCasualBatchDesc
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetEmployeeFirstBankId') then
   drop procedure FGetEmployeeFirstBankId
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetIR21A1S2Items') then
   drop procedure FGetIR21A1S2Items
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetIR21Indicator') then
   drop procedure FGetIR21Indicator
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetIRASNationalityCode') then
   drop procedure FGetIRASNationalityCode
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetTimeSheetCurAdditionalWage') then
   drop procedure FGetTimeSheetCurAdditionalWage
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetTimeSheetCurOrdinaryWage') then
   drop procedure FGetTimeSheetCurOrdinaryWage
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'FGetYEEmployerId') then
   drop procedure FGetYEEmployerId
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetYEKeywordDefaultName') then
   drop procedure FGetYEKeywordDefaultName
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetYEKeywordUserDefinedName') then
   drop procedure FGetYEKeywordUserDefinedName
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetYEOverseasCPFAmount') then
   drop procedure FGetYEOverseasCPFAmount
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'FGetYERecordStatus') then
   drop procedure FGetYERecordStatus
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewA8A') then
   drop procedure InsertNewA8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewA8AS2') then
   drop procedure InsertNewA8AS2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewA8AS3') then
   drop procedure InsertNewA8AS3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewA8B') then
   drop procedure InsertNewA8B
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewA8BRecord') then
   drop procedure InsertNewA8BRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewCasRecord') then
   drop procedure InsertNewCasRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewEmploymentHistory') then
   drop procedure InsertNewEmploymentHistory
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR21A2') then
   drop procedure InsertNewIR21A2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR21A2Record') then
   drop procedure InsertNewIR21A2Record
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR21A3') then
   drop procedure InsertNewIR21A3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR21A3Record') then
   drop procedure InsertNewIR21A3Record
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR21Details') then
   drop procedure InsertNewIR21Details
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR8A') then
   drop procedure InsertNewIR8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR8S') then
   drop procedure InsertNewIR8S
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR8SA') then
   drop procedure InsertNewIR8SA
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIR8SC') then
   drop procedure InsertNewIR8SC
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewIRASNationality') then
   drop procedure InsertNewIRASNationality
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewNSPayCase') then
   drop procedure InsertNewNSPayCase
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewYEEmployee') then
...
if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewYEGlobal') then
   drop procedure InsertNewYEGlobal
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'InsertNewYERecord') then
   drop procedure InsertNewYERecord
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'IsA8AS2UseActualValue') then
   drop procedure IsA8AS2UseActualValue
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'IsCPFProgExists') then
   drop procedure IsCPFProgExists
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'IsRecordUpdatedA8A') then
   drop procedure IsRecordUpdatedA8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'IsRecordUpdatedA8B') then
   drop procedure IsRecordUpdatedA8B
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'IsRecordUpdatedIR8A') then
   drop procedure IsRecordUpdatedIR8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'IsRecordUpdatedIR8S') then
   drop procedure IsRecordUpdatedIR8S
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'IsRecordUpdatedYEEmployee') then
   drop procedure IsRecordUpdatedYEEmployee
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'IsYEPeriodOverseas') then
   drop procedure IsYEPeriodOverseas
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'PatchMOSQYMF') then
   drop procedure PatchMOSQYMF
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateA8A') then
   drop procedure UpdateA8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateA8AS2') then
   drop procedure UpdateA8AS2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateA8AS3') then
   drop procedure UpdateA8AS3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateA8B') then
   drop procedure UpdateA8B
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateA8BRecord') then
   drop procedure UpdateA8BRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateCasRecord') then
   drop procedure UpdateCasRecord
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateEmploymentHistory') then
   drop procedure UpdateEmploymentHistory
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR21A2') then
   drop procedure UpdateIR21A2
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR21A2Record') then
   drop procedure UpdateIR21A2Record
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR21A3') then
   drop procedure UpdateIR21A3
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR21A3Record') then
   drop procedure UpdateIR21A3Record
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR21Details') then
   drop procedure UpdateIR21Details
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR8A') then
   drop procedure UpdateIR8A
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR8S') then
   drop procedure UpdateIR8S
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR8SA') then
   drop procedure UpdateIR8SA
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIR8SC') then
   drop procedure UpdateIR8SC
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateIRASNationality') then
   drop procedure UpdateIRASNationality
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateNSPayCase') then
   drop procedure UpdateNSPayCase
end if
;
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateYEEmployee') then
...
if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateYEGlobal') then
   drop procedure UpdateYEGlobal
end if
;

if exists(select 1 from sys.sysprocedure where proc_name = 'UpdateYERecord') then
   drop procedure UpdateYERecord
end if
;
