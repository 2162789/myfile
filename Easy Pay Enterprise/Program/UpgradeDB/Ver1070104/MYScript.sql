update MalTaxRecord set MalTaxOtherAllowanceExGratuity = MalTaxOtherAllowance;
...
in In_MalTaxOtherAllowanceExGratuity double,
...
begin
  ...
  elseif not In_MalTaxPolicyId = any(select MalTaxPolicyId from MalTaxPolicy) then
    ...
    insert into MalTaxRecord(PersonalSysId,
      ...
      MalTaxChildRebate,
	  MalTaxOtherAllowanceExGratuity) values(
      In_PersonalSysId,
      In_MalTaxYear,
      In_MalTaxEmployerId,
      In_MalTaxPolicyId,
	  ...
	  In_MalTaxOtherAllowanceExGratuity);
    commit work
  end if;
...
begin
  ...
  elseif not In_MalTaxPolicyId = any(select MalTaxPolicyId from MalTaxPolicy) then
    ...
    update MalTaxRecord set
      ...
      MalTaxChildRebate = In_MalTaxChildRebate,
	  MalTaxOtherAllowanceExGratuity = In_MalTaxOtherAllowanceExGratuity where
