...
FROM UpgradeDB\Ver1030106\ID_SystemRpt.dat
FORMAT ASCII
BY ORDER;

INPUT INTO SystemRptComp
FROM UpgradeDB\Ver1030106\ID_SystemRptComp.dat
FORMAT ASCII
BY ORDER;

INPUT INTO RptConfig
FROM UpgradeDB\Ver1030106\ID_RptConfig.dat
FORMAT ASCII
...
FROM UpgradeDB\Ver1030106\ID_RptCompConfig.dat
FORMAT ASCII
BY ORDER;

INPUT INTO RptCompItemConfig
FROM UpgradeDB\Ver1030106\ID_RptCompItemConfig.dat
FORMAT ASCII
BY ORDER;