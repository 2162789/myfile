...
FROM UpgradeDB\Ver1030106\HK_SystemRpt.dat
FORMAT ASCII
BY ORDER;

INPUT INTO SystemRptComp
FROM UpgradeDB\Ver1030106\HK_SystemRptComp.dat
FORMAT ASCII
BY ORDER;

INPUT INTO RptConfig
FROM UpgradeDB\Ver1030106\HK_RptConfig.dat
FORMAT ASCII
...
FROM UpgradeDB\Ver1030106\HK_RptCompConfig.dat
FORMAT ASCII
BY ORDER;

INPUT INTO RptCompItemConfig
FROM UpgradeDB\Ver1030106\HK_RptCompItemConfig.dat
FORMAT ASCII
BY ORDER;