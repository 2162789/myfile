...
BEGIN
    ...
    Select Sum(SDFWage) into Out_Taxableamount From PeriodPolicySummary Where EmployeeSysID=In_EmployeeSysID And PayRecYear=In_TaxYear 
    And PayrecPeriod=In_TaxPeriod;
   
    Select First SubPeriodEndDate into Out_SubPeriodEndDate From PayGroupPeriod where PayGroupYear=In_TaxYear and PayGroupPeriod=In_TaxPeriod
